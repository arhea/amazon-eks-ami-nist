...
chmod -R 0644 /usr/lib/systemd/system/docker.service
chown -R root:root /usr/lib/systemd/system/docker.service

chmod -R 0644 /usr/lib/systemd/system/docker.socket
chown -R root:root /usr/lib/systemd/system/docker.socket
